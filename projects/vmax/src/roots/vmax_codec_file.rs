...
/// [`VMaxCodecPaletteSettingsVmaxpsbFile`](crate::VMaxCodecPaletteSettingsVmaxpsbFile));
/// the codec's top-level type, encoded into a
/// [`VMaxSerdeFile`](crate::VMaxSerdeFile) for writing.

/// The base color, a color property with straight alpha.
...
/// Normal map scale, a `0..` scalar.
pub const NORMAL_SCALE: &str = "normalScale";

/// The standard default for [`NORMAL_SCALE`].
pub const NORMAL_SCALE_DEFAULT: f64 = 1.0;
...
/// The alpha cutoff of a masked material, a `0..` scalar.
pub const ALPHA_CUTOFF: &str = "alphaCutoff";

/// The standard default for [`ALPHA_CUTOFF`].
pub const ALPHA_CUTOFF_DEFAULT: f64 = 0.5;

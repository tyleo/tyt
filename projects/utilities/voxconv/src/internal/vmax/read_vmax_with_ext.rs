use crate::{Result, VoxDocumentFile, box_ext, ext::VoxconvVoxMain, package_file};
...
pub fn read_vmax_with_ext<D>(dependencies: &D, files: &[VoxDocumentFile]) -> Result<VoxconvVoxMain>
where

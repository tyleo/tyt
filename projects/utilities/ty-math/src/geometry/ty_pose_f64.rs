...
impl TyPoseF64 {
    ...
    /// This pose with a uniform `scale`, as a [`TyUniformTrsF64`].
    pub fn with_uniform_scale(&self, scale: f64) -> TyUniformTrsF64 {
        TyUniformTrsF64::new(self.position, self.rotation, scale)
    }
}

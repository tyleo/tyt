...
/// Decodes a format ext from its entry value: the read half behind a
/// [`VoxExtEntryCodec`](crate::ext::VoxExtEntryCodec) impl. A value that does
/// not decode as `T` is an error.
...
#[cfg(test)]
mod tests {
    use crate::ext::json::{ext_from_vox_value, vox_value_from_ext};

...
use voxsmith::{VMaxVoxMain, from_voxj_bytes};

/// Loads the voxel file at `input` into a [`VMaxVoxMain`] for the Voxel
...
pub fn load_state_vmax(input: &Path, from: Option<Format>) -> Result<VMaxVoxMain> {

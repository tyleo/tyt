/// How [`palette_show`](crate::operations::palette_show::palette_show())
/// arranges its value collections and serializes them.
...
pub enum PaletteShowLayout {
    ...
    /// 0-based material indices, shaped by
    /// [`PaletteShowTableShape`](crate::operations::palette_show::PaletteShowTableShape).
    Tables,

use crate::operations::palette_show::{
    PaletteRef, PaletteShowPresentation, PaletteShowReading, PropertyRef,
};

/// A selector naming one or more value collections for
/// [`palette_show`](crate::operations::palette_show::palette_show()): a
/// property's values down a palette, with how each value renders. The default
/// names every property of every palette under the `Auto` presentation and
/// reading.

use crate::operations::palette_show::{PaletteShowLabel, PaletteShowLayout, PaletteShowTableShape};
use std::num::NonZeroU8;

/// How [`palette_show`](crate::operations::palette_show::palette_show()) lays
/// out its output. Each layout errors on an option it ignores. The default is
/// the `Rows` layout with concat labels, headings from `#`, nested tables, and
/// no wrapping.

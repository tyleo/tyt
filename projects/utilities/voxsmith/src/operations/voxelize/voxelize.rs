use crate::{
    Result,
    operations::voxelize::{GridResolution, Mesh, ResolutionAxis, VoxelizeOptions, voxelize_mesh},
...
mod tests {
    ...
    use crate::{
        operations::voxelize::{
            FillMode, GridResolution, MaterialMode, Mesh, MeshMaterial, MeshTriangle,

use crate::operations::hierarchy_show::{HierarchyShowLayout, HierarchyViews, PatternView};

/// The options
/// [`hierarchy_show`](crate::operations::hierarchy_show::hierarchy_show())
/// takes. The default renders the whole scene as a box-glyph tree with no
/// views.

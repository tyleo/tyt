use crate::{
    Error, HierarchyShowLayout, HierarchyShowOptions, HierarchyViews, PatternView, Result,
};
...
pub fn render_hierarchy_show<T>(
    state: &VoxMain<T>,
...
mod tests {
    use crate::{
        HierarchyShowLayout, HierarchyShowOptions, HierarchyViews, OriginView, PatternView, Result,

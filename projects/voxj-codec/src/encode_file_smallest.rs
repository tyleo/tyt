use crate::{encode_object_smallest, palette_cell_counts};
...
/// smallest-deflated search ([`encode_object_smallest`](crate::encode_object_smallest)).
...
/// unchanged.
pub fn encode_file_smallest(file: &VoxjCodecFile) -> VoxjSerdeFile {
    ...
    let objects = file
        ...
        .map(|object| {
            ...
            encode_object_smallest(object, &cell_counts)
        })
        .collect();
    VoxjSerdeFile {

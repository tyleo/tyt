...
/// inverse of [`from_vox_file_bytes`](crate::from_vox_file_bytes).
///
...
/// [`from_vox_file_bytes`](crate::from_vox_file_bytes) re-encodes to an
...
pub fn to_vox_file_bytes(file: &MVoxFile) -> Vec<u8> {

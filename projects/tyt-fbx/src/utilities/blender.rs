...
pub const FBX_RENAME_OBJECTS_PY: Script = embed_blender_script!("fbx_rename_objects.py");
pub const FBX_RENDER_PY: Script = embed_blender_script!("fbx_render.py");

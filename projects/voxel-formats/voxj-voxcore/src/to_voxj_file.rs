use crate::{
    EditStateMode, Result, VoxjVoxMain, VoxjWriteOptions, voxj_decoded_object_from_vox_object,
    voxj_hierarchy_node_from_vox_hierarchy_node, voxj_map_from_vox_map_entries,
...
/// the inverse of [`from_voxj_file`](crate::from_voxj_file). An empty ext
/// writes no block, and `options` can drop the block.
///

use crate::{
    EditStateMode, Result, VoxjWriteOptions, voxj_decoded_object_from_vox_object,
...
/// Encodes a [`VoxMain`] into a [`VoxjFile`], the inverse of
/// [`from_voxj_file`](crate::from_voxj_file).
///

...
/// [`check_voxj_file`](crate::validation::check_voxj_file()) reports a result for.
...
impl Check {
    /// The short stable identifier reported as [`VoxjCheck::name`](crate::validation::VoxjCheck::name).

...
//! the `to_x_file_with_ext` writers write it back. [`QbExt`] and [`QbtExt`]
//! follow the state's listings through voxcore's
//! [`VoxExt`](voxcore::ext::VoxExt) hooks. Each ext enters a document's

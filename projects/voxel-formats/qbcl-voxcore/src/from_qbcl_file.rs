...
/// [`to_qbcl_file`](crate::to_qbcl_file) writes the state back as a
/// synthesized file. The `ext` feature's `ext::from_qbcl_file_with_ext` keeps
/// that state instead.
///
